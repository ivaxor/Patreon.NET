...
public class PatreonCurrentUserV1Response
{
    ...
    public PatreonCurrentUserV1Response(PatreonRawResponseSingle<PatreonUserV1Attributes, PatreonUserV1Relationships> response) : this(response.Data.Attributes, response.Data.Relationships, response.Included?.ToDictionary(_ => _.Id, _ => _)) { }

    public PatreonCurrentUserV1Response(PatreonUserV1Attributes attributes, PatreonUserV1Relationships? relationships, Dictionary<string, PatreonIncludeData>? includedData)
    {
        User = attributes;
